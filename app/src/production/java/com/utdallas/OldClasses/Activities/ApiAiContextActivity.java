...
/**
 * Created by sxk159231 on 1/14/2016.
 */
public class ApiAiContextActivity extends Activity implements AIButton.AIButtonListener{

    AutoCompleteTextView tvQuestion;
    AIButton micButton;
    private final String TAG = "ApiAiContextActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helperClass = new HomeActivityHelper(ApiAiContextActivity.this);
        helperClass.getBuildingsList();
        configureMic(micButton);
        tts = new TextToSpeech(ApiAiContextActivity.this, new TextToSpeech.OnInitListener() {
            @Override
